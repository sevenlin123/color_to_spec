...
This skill allows the agent to reconstruct full-resolution asteroid reflectance spectra ($0.3\ \mu\text{m}$ to $5.2\ \mu\text{m}$) with uncertainty bounds from input magnitude colors (e.g., $g-r, r-i, i-z, r-z$ in LSST or $g-r, r-z$ in DES).
